...
import com.minibank.corebanking.dto.CounterAdminStaffUpsertRequest;
import com.minibank.corebanking.dto.CounterResponse;
import com.minibank.corebanking.entity.Counter;
import com.minibank.corebanking.exception.BadRequestException;
import com.minibank.corebanking.exception.UnauthorizedException;
...
public class CounterAdminController {
    ...
    public ResponseEntity<ApiResponse<CounterResponse>> getMyCounter(
        ...
        } catch (com.minibank.corebanking.exception.NotFoundException e) {
