package com.minibank.corebanking.repository;
...
public interface TransactionRepository extends JpaRepository<Transaction, UUID> {
    ...
    @Query("""
            ...
            where t.staffId = :staffId
              and t.type in (com.minibank.corebanking.entity.TransactionType.COUNTER_DEPOSIT, 
                            com.minibank.corebanking.entity.TransactionType.COUNTER_WITHDRAW)
            order by t.timestamp desc
            """)
    ...
    @Query("""
            ...
            where t.staffId = :staffId
              and t.type in (com.minibank.corebanking.entity.TransactionType.COUNTER_DEPOSIT,
                            com.minibank.corebanking.entity.TransactionType.COUNTER_WITHDRAW)
              and t.status = com.minibank.corebanking.entity.TransactionStatus.PENDING
            order by t.timestamp desc
            """)
    ...
    @Query("""
            select count(t) from Transaction t
            where t.staffId = :staffId
              and t.type = com.minibank.corebanking.entity.TransactionType.COUNTER_DEPOSIT
              and t.status = com.minibank.corebanking.entity.TransactionStatus.PENDING
            """)
    ...
    @Query("""
            ...
            where t.staffId = :staffId
              and t.type in (com.minibank.corebanking.entity.TransactionType.COUNTER_DEPOSIT,
                            com.minibank.corebanking.entity.TransactionType.COUNTER_WITHDRAW)
              and t.status = com.minibank.corebanking.entity.TransactionStatus.SUCCESS
    ...
    @Query("""
            select coalesce(sum(t.amount), 0) from Transaction t
            where t.status = com.minibank.corebanking.entity.TransactionStatus.SUCCESS
              and t.timestamp >= :fromTime and t.timestamp < :toTime
            """)
